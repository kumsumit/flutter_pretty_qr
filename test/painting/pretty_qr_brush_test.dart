...
class _TestBrushPainter extends CustomPainter {
  ...
  @literal
  const _TestBrushPainter({required this.brush, this.textDirection});
...
void main() {
  ...
  group('PrettyQrBrush.transparent', () {
    test('returns correct transparent brush', () {
      // act
  ...
  group('PrettyQrBrush.from', () {
    test('returns correct brush when source is Color', () {
      // arrange
    ...
    test('returns identical brush when source is PrettyQrBrush', () {
      // arrange
  ...
  group('PrettyQrBrush.lerp', () {
    test('returns correct value when lerps from color to gradient', () {
      // arrange
    ...
    test('returns correct value when lerps from gradient to color', () {
      // arrange
    ...
    test('returns correct value when lerps from gradient to gradient', () {
      // arrange
      const instance1 = PrettyQrGradientBrush(
        gradient: LinearGradient(
          colors: [Color(0xFF000000), Color(0xFF7F7F7F)],
    ...
    test('lerp returns correct value when destination is null and offset is '
        'less than 0.5', () {
      // arrange
    ...
    test('lerp returns correct value when source is null and offset is '
        'less than 0.5', () {
      // arrange
      const brush = PrettyQrSolidBrush(0xFFFFFFFF);
  ...
  group('PrettyQrSolidBrush', () {
    test('should be equal when instance is the same', () {
      // arrange
    ...
    test('should be equal when instances are different', () {
      // arrange
    ...
    test('should not be equal when runtime types are different', () {
      // arrange
      final instance1 = PrettyQrSolidBrush(testColor.value);
    ...
    test('should not be equal when colors are different', () {
      // arrange
      final instance1 = PrettyQrSolidBrush(testColor.value);
    ...
    group('toPaint', () {
      test('returns correct Paint object', () {
        // arrange
        final brush = PrettyQrSolidBrush(testColor.value);

        // act
        final paint = brush.toPaint(Rect.zero, textDirection: null);

        // assert
        expect(paint.color.toARGB32(), equals(testColor.toARGB32()));
  ...
  group('PrettyQrGradientBrush', () {
    ...
    test('should not be equal when gradients are different', () {
      // arrange
      final instance1 = PrettyQrGradientBrush(gradient: testGradient);
      const instance2 = PrettyQrGradientBrush(
        gradient: LinearGradient(
    ...
    group('value', () {
      test('return transparent when gradient colors is empty', () {
        // arrange
      ...
      test('return first color from gradient when colors is not empty', () {
        // arrange
    ...
    group('toPaint', () {
      ...
      test('returns correct Paint object', () {
        ...
        // act
        final paint = brush.toPaint(rect, textDirection: TextDirection.rtl);
